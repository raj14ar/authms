...
public class AuthTests {
	...
	@Test
	 void login2() throws JsonProcessingException, Exception {
...
//before find the method is checked here	
	@Test
	 void getOneEmployees() throws JsonProcessingException, Exception {
	...
	@Test
	 void getOneEmployees1() throws JsonProcessingException, Exception {
		System.err.println(token);
	...
	@Test
	 void geHealth() throws JsonProcessingException, Exception {
		System.err.println(token);
	...
	@Test
	 void geHealthNeg() throws JsonProcessingException, Exception {
		System.err.println(token);
		MvcResult andReturn = mockMvc.perform(MockMvcRequestBuilders.get("/health").accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk()).andReturn();
	...
	@Test
	 void geValidate() throws JsonProcessingException, Exception {
		System.err.println(token);
	...
	@Test
	 void getNotValidate() throws JsonProcessingException, Exception {
		System.err.println(token);
...
//	
	@Test
	 void setterNameTest() throws NoSuchFieldException, IllegalAccessException {
		// given
	...
	@Test
	 void setterNameTestNeg() throws NoSuchFieldException, IllegalAccessException {
		// given
		AppUser pojo = new AppUser();
		// when
...
//	
	@Test
	 void getterNameTest() throws NoSuchFieldException, IllegalAccessException {
		// given
		AppUser pojo = new AppUser();
		java.lang.reflect.Field field = pojo.getClass().getDeclaredField("username");
		field.setAccessible(true);
	...
	@Test
	 void getterNameTestNeg() throws NoSuchFieldException, IllegalAccessException {
		// given
		AppUser pojo = new AppUser();
		java.lang.reflect.Field field = pojo.getClass().getDeclaredField("username");
		field.setAccessible(true);
	...
	@Test
	 void setterPassTest() throws NoSuchFieldException, IllegalAccessException {
		// given
		AppUser pojo = new AppUser();
		// when
	...
	@Test
	 void setterPassTestNeg() throws NoSuchFieldException, IllegalAccessException {
		// given
		AppUser pojo = new AppUser();
		// when
